          ...
          <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {sections.map((section) => (
                    <button
                      ...
                      className="text-left text-sm text-primary hover:underline py-1"
                    >
                      {section.title}
                    </button>
                  ))}
            ...
            <div className="prose prose-sm max-w-none space-y-8">
              ...
              <section id="company-info">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">2. COMPANY INFORMATION</h2>
              ...
              <section id="intellectual-property">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">3. INTELLECTUAL PROPERTY</h2>
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Customer License</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="user-accounts">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">4. USER ACCOUNTS & RESPONSIBILITIES</h2>
              ...
              <section id="fees-billing">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">5. FEES, BILLING & SUBSCRIPTIONS</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  All paid Services require valid payment information.
                </p>
                <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Billing Terms</h3>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <section id="cancellation">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">6. CANCELLATION</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="prohibited">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">7. PROHIBITED ACTIVITIES</h2>
              ...
              <section id="user-content">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">8. USER CONTENT</h2>
                <h3 className="text-xl font-semibold mt-4 mb-3 text-foreground">Ownership</h3>
                <p className="text-muted-foreground leading-relaxed">
                  You retain ownership of documents, data, and materials you upload ("Customer Content").
                </p>
                <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">License to Gaapio</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="feedback">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">9. FEEDBACK & SUBMISSIONS</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="government">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">10. U.S. GOVERNMENT USE</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="service-management">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">11. SERVICE MANAGEMENT</h2>
              ...
              <section id="term-termination">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">12. TERM & TERMINATION</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="service-availability">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">13. SERVICE AVAILABILITY</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="governing-law">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">14. GOVERNING LAW</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="dispute-resolution">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">15. DISPUTE RESOLUTION</h2>
                <h3 className="text-xl font-semibold mt-4 mb-3 text-foreground">Informal Negotiations</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Before initiating arbitration, parties must attempt to resolve disputes informally for 30 days.
                </p>
                <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Binding Arbitration</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Class Action Waiver</h3>
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Exceptions</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="corrections">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">16. CORRECTIONS</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="disclaimer">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">17. DISCLAIMER OF WARRANTIES</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="limitation">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">18. LIMITATION OF LIABILITY</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="indemnification">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">19. INDEMNIFICATION</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="user-data">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">20. USER DATA & BACKUPS</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section id="electronic-communications">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">21. ELECTRONIC COMMUNICATIONS & SIGNATURES</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="miscellaneous">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">22. MISCELLANEOUS</h2>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <section id="contact">
                <h2 className="text-2xl font-semibold mb-3 text-foreground">23. CONTACT US</h2>
                <div className="bg-muted/30 p-4 rounded-lg border border-border">
                  <p className="font-semibold text-foreground">Gaapio, Inc.</p>
                  <p className="text-muted-foreground">Email: support@gaapio.com</p>
