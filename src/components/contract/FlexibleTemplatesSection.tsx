    ...
    <section ref={sectionRef} className="py-24 md:py-32 relative overflow-hidden bg-muted/30">
      <ResponsiveContainer className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          ...
          {/* Right: Template builder mockup — stacked cards, NOT a full-width list */}
          <div className={cn(
            "relative transition-all duration-700 lg:pt-8",
            ...
            {/* Stacked template cards — offset for depth */}
            <div className="relative space-y-4">
              ...
              <div className={cn(
                ...
                {/* Inline step preview — compact tree view */}
                <div className="bg-muted/40 rounded-lg p-4 space-y-2">
                  {[
                    ...
                    <div
                      ...
                      style={{ paddingLeft: `${step.indent * 20}px` }}
                    >
                      {step.icon === "folder" ? (
              ...
              {/* Card 3 — Collapsed, slight offset */}
              <div className={cn(
