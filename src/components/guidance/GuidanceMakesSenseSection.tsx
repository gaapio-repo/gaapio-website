      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">No more deciphering complex regulatory language</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Actionable steps to apply changes immediately</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Every summary is written and reviewed by certified professionals</p>
          </div>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-background rounded-2xl shadow-xl border border-border p-8 max-w-2xl w-full relative">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl text-foreground">ASC 326 Update</h3>
                  <p className="text-sm text-muted-foreground">Current Expected Credit Loss</p>
                </div>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h4 className="font-bold text-foreground mb-2">What Changed:</h4>
                  <p className="text-muted-foreground text-sm leading-relaxed">FASB clarified how to estimate credit losses for financial instruments with embedded features.</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-foreground mb-2">Impact:</h4>
                  <p className="text-muted-foreground text-sm">Medium - Affects companies with complex financial instruments</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-foreground mb-2">Action Required:</h4>
                  <p className="text-muted-foreground text-sm">Review credit loss methodologies by Q2 2025</p>
                </div>
              </div>
