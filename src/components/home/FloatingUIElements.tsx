  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto">
        <div className="bg-background rounded-lg shadow-2xl p-6 border border-border animate-float">
      ...
      <div className="absolute top-0 right-0 md:right-8 lg:right-16 z-20 animate-float-delayed hidden md:block">
        <div className="bg-background rounded-lg shadow-xl p-4 border border-border w-48">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-foreground">10hrs</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-0 md:left-8 lg:left-16 z-20 animate-float-delayed-more hidden md:block">
        <div className="bg-background rounded-lg shadow-xl p-4 border border-border w-52">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">CPA Accuracy</p>
      ...
      <div className="absolute top-12 left-0 md:left-4 lg:left-8 z-20 animate-float hidden lg:block">
        <div className="bg-background rounded-full shadow-xl px-4 py-2 border border-border flex items-center gap-2">
      ...
      <div className="absolute bottom-16 right-0 md:right-4 lg:right-8 z-20 animate-float-delayed hidden lg:block">
        <div className="bg-background rounded-lg shadow-xl p-3 border border-border flex items-center gap-2">
